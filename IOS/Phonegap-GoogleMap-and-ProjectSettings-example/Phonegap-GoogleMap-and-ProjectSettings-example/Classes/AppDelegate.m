...
//
//  AppDelegate.m
//  Phonegap-GoogleMap-and-ProjectSettings-example
//
//  Created by Christian Engvall on 2012-04-05.
//  Copyright Sogeti 2012. All rights reserved.
//
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"Phonegap-GoogleMap-and-ProjectSettings-example launchOptions = %@", url);
    }    
